...
func (c *loginServiceClient) Login(ctx context.Context, in *LoginMessage, opts ...grpc.CallOption) (*LoginMessage, error) {
...
func (UnimplementedLoginServiceServer) Login(context.Context, *LoginMessage) (*LoginMessage, error) {
