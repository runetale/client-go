...
func (c *sessionServiceClient) Login(ctx context.Context, in *LoginMessage, opts ...grpc.CallOption) (*LoginMessage, error) {
	out := new(LoginMessage)
	err := c.cc.Invoke(ctx, "/protos.SessionService/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SessionService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.SessionService/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SessionServiceServer).Login(ctx, req.(*LoginMessage))
	}
	return interceptor(ctx, in, info, handler)
}
