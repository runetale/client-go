...
func (x *GetInvitationRequest) Reset() {
	*x = GetInvitationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_runetale_runetale_v1_oidc_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetInvitationRequest) Descriptor() ([]byte, []int) {
	return file_runetale_runetale_v1_oidc_proto_rawDescGZIP(), []int{3}
}
...
type GetInvitationResponse struct {
	...
	InvitationSub   string `protobuf:"bytes,2,opt,name=invitationSub,proto3" json:"invitationSub,omitempty"`
	InvitationEmail string `protobuf:"bytes,3,opt,name=invitationEmail,proto3" json:"invitationEmail,omitempty"`
}

func (x *GetInvitationResponse) Reset() {
	*x = GetInvitationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_runetale_runetale_v1_oidc_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetInvitationResponse) Descriptor() ([]byte, []int) {
	return file_runetale_runetale_v1_oidc_proto_rawDescGZIP(), []int{4}
}

func (x *GetInvitationResponse) GetInviteID() string {
	if x != nil {
		return x.InviteID
	}
	return ""
...
func (x *GetInvitationResponse) GetInvitationSub() string {
	if x != nil {
		return x.InvitationSub
	}
	return ""
}

func (x *GetInvitationResponse) GetInvitationEmail() string {
	if x != nil {
...
var file_runetale_runetale_v1_oidc_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0a, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x22, 0x96, 0x01,
	...
	,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x4e, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74,
...
var file_runetale_runetale_v1_oidc_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_runetale_runetale_v1_oidc_proto_goTypes = []interface{}{
	...
	(*GetInvitationRequest)(nil),  // 3: protos.GetInvitationRequest
	(*GetInvitationResponse)(nil), // 4: protos.GetInvitationResponse
...
var file_runetale_runetale_v1_oidc_proto_depIdxs = []int32{
	...
	5, // 1: protos.OIDCService.Authenticate:input_type -> google.protobuf.Empty
	3, // 2: protos.OIDCService.GetInvitation:input_type -> protos.GetInvitationRequest
	...
	4, // 5: protos.OIDCService.GetInvitation:output_type -> protos.GetInvitationResponse
...
func file_runetale_runetale_v1_oidc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_runetale_runetale_v1_oidc_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_runetale_runetale_v1_oidc_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
