...
func (c *machineServiceClient) SyncRemoteMachinesConfig(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*SyncMachinesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MachineService_SyncRemoteMachinesConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *machineServiceClient) ComposeMachine(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ComposeMachineResponse, error) {
	...
	err := c.cc.Invoke(ctx, MachineService_ComposeMachine_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
