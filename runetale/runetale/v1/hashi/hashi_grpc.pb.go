...
func (UnimplementedHashiServiceServer) NetCheck(context.Context, *emptypb.Empty) (*NetCheckReport, error) {
	return nil, status.Error(codes.Unimplemented, "method NetCheck not implemented")
}
...
func RegisterHashiServiceServer(s grpc.ServiceRegistrar, srv HashiServiceServer) {
	// If the following call panics, it indicates UnimplementedHashiServiceServer was
