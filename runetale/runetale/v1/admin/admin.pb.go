...
var file_runetale_runetale_v1_admin_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x6f, 0x64, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x27, 0x0a, 0x0f, 0x47, 0x65,
	0x74, 0x46, 0x6c, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a,
	0x05, 0x61, 0x63, 0x6c, 0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x61, 0x63,
	0x6c, 0x49, 0x44, 0x22, 0x2f, 0x0a, 0x06, 0x46, 0x6c, 0x65, 0x65, 0x74, 0x73, 0x12, 0x25, 0x0a,
	...
	0x65, 0x65, 0x74, 0x73, 0x22, 0x99, 0x01, 0x0a, 0x11, 0x50, 0x61, 0x74, 0x63, 0x68, 0x46, 0x6c,
	...
	0x76, 0x69, 0x63, 0x65, 0x52, 0x07, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2a, 0x72, 0x0a,
	...
	0x08, 0x2a, 0x24, 0x0a, 0x09, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b,
	0x0a, 0x07, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x10, 0x01, 0x32, 0xfc, 0x01, 0x0a, 0x0a, 0x41, 0x63, 0x6c, 0x53,
...
var file_runetale_runetale_v1_admin_proto_goTypes = []interface{}{
	...
	(GroupType)(0),                 // 1: protos.GroupType
...
var file_runetale_runetale_v1_admin_proto_depIdxs = []int32{
	...
	27, // 7: protos.Fleets.fleets:type_name -> protos.Fleet
	0,  // 8: protos.PatchFleetRequest.type:type_name -> protos.DeploymentMethod
	28, // 9: protos.Fleet.resources:type_name -> protos.Resource
	27, // 10: protos.Resource.fleets:type_name -> protos.Fleet
	30, // 11: protos.Resource.users:type_name -> protos.User
	29, // 12: protos.Resource.groups:type_name -> protos.Group
	28, // 13: protos.Resource.resources:type_name -> protos.Resource
	30, // 14: protos.Group.users:type_name -> protos.User
	27, // 15: protos.Group.fleets:type_name -> protos.Fleet
	28, // 16: protos.Group.resources:type_name -> protos.Resource
	1,  // 17: protos.Group.type:type_name -> protos.GroupType
	27, // 18: protos.User.fleets:type_name -> protos.Fleet
	28, // 19: protos.User.resources:type_name -> protos.Resource
	31, // 20: protos.User.devices:type_name -> protos.Device
	29, // 21: protos.User.groups:type_name -> protos.Group
	27, // 22: protos.Device.fleets:type_name -> protos.Fleet
	28, // 23: protos.Device.resources:type_name -> protos.Resource
	29, // 24: protos.Device.groups:type_name -> protos.Group
	31, // 25: protos.Device.devices:type_name -> protos.Device
	2,  // 26: protos.AclService.CreateAcl:input_type -> protos.CreateAclRequest
	3,  // 27: protos.AclService.PatchAcl:input_type -> protos.PatchAclRequest
	4,  // 28: protos.AclService.GetAcl:input_type -> protos.GetAclRequest
	32, // 29: protos.AclService.GetAcls:input_type -> google.protobuf.Empty
	32, // 30: protos.UserService.GetMe:input_type -> google.protobuf.Empty
	8,  // 31: protos.UserService.GetUser:input_type -> protos.GetUserRequest
	32, // 32: protos.UserService.GetUsers:input_type -> google.protobuf.Empty
	10, // 33: protos.GroupService.CreateGroup:input_type -> protos.CreateGroupRequest
	11, // 34: protos.GroupService.GetGroup:input_type -> protos.GetGroupRequest
	32, // 35: protos.GroupService.GetGroups:input_type -> google.protobuf.Empty
	14, // 36: protos.GroupDetailService.PatchGroup:input_type -> protos.PatchGroupRequest
	15, // 37: protos.DeviceService.GetDevice:input_type -> protos.GetDevicesRequest
	32, // 38: protos.DeviceService.GetDevices:input_type -> google.protobuf.Empty
	17, // 39: protos.ResourceService.CreateResource:input_type -> protos.CreateResourceRequest
	19, // 40: protos.ResourceService.GenerateToken:input_type -> protos.GenerateTokenRequest
	21, // 41: protos.ResourceService.GetResource:input_type -> protos.GetResourceRequest
	32, // 42: protos.ResourceService.GetResources:input_type -> google.protobuf.Empty
	23, // 43: protos.FleetService.CreateFleet:input_type -> protos.CreateFleetRequest
	24, // 44: protos.FleetService.GetFleet:input_type -> protos.GetFleetRequest
	32, // 45: protos.FleetService.GetFleets:input_type -> google.protobuf.Empty
	26, // 46: protos.FleetDetailService.PatchFleet:input_type -> protos.PatchFleetRequest
	6,  // 47: protos.AclService.CreateAcl:output_type -> protos.AclResponse
	6,  // 48: protos.AclService.PatchAcl:output_type -> protos.AclResponse
	6,  // 49: protos.AclService.GetAcl:output_type -> protos.AclResponse
	5,  // 50: protos.AclService.GetAcls:output_type -> protos.GetAclsResponse
	7,  // 51: protos.UserService.GetMe:output_type -> protos.GetMeResponse
	30, // 52: protos.UserService.GetUser:output_type -> protos.User
	9,  // 53: protos.UserService.GetUsers:output_type -> protos.Users
	29, // 54: protos.GroupService.CreateGroup:output_type -> protos.Group
	29, // 55: protos.GroupService.GetGroup:output_type -> protos.Group
	12, // 56: protos.GroupService.GetGroups:output_type -> protos.Groups
	29, // 57: protos.GroupDetailService.PatchGroup:output_type -> protos.Group
	31, // 58: protos.DeviceService.GetDevice:output_type -> protos.Device
	16, // 59: protos.DeviceService.GetDevices:output_type -> protos.Devices
	18, // 60: protos.ResourceService.CreateResource:output_type -> protos.CreateResourceResponse
	20, // 61: protos.ResourceService.GenerateToken:output_type -> protos.GenerateTokenResponse
	28, // 62: protos.ResourceService.GetResource:output_type -> protos.Resource
	22, // 63: protos.ResourceService.GetResources:output_type -> protos.Resources
	27, // 64: protos.FleetService.CreateFleet:output_type -> protos.Fleet
	27, // 65: protos.FleetService.GetFleet:output_type -> protos.Fleet
	25, // 66: protos.FleetService.GetFleets:output_type -> protos.Fleets
	29, // 67: protos.FleetDetailService.PatchFleet:output_type -> protos.Group
